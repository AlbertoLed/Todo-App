        ...
        <main className="min-h-[100vh] bg-auth-bg text-white flex flex-col justify-center items-center">
            ...
            <div className="flex flex-col w-[90%] max-w-[630px] min-h-[640px] max-h-[754px] h-[90vh] my-5 bg-auth-card rounded-2xl shadow-lg shadow-grayish-104 lg:flex-row-reverse lg:h-[700px] lg:max-w-[1160px]">
                ...
                <div className="w-5/6 h-1/2 self-center flex flex-col justify-center lg:h-full lg:w-[330px] lg:mx-auto">
                    ...
                    {/* Login Button */}
                    <Button 
                    className="bg-auth-blue text-white mb-4 shadow-md shadow-grayish-104 hover:bg-auth-blue-h transition-colors lg:text-lg"
                    onClick={selectLogin}>Login</Button>
                    {/* Sign Up button */}
                    <Button 
                    className="border-auth-blue text-auth-blue border-[2px] p-2.5 hover:border-auth-blue-h hover:text-auth-blue-h transition-colors lg:text-lg" 
                    bgVoid={true}
                    onClick={selectSignUp}>Sign Up</Button>
                    {/* Or text */}
                    <div className="flex justify-center items-center">
                        <div className="w-20 h-[2px] bg-auth-blue"></div>
                        <span className="mx-5 my-7 text-auth-gray text-xs lg:text-base">Or</span>
                        <div className="w-20 h-[2px] bg-auth-blue"></div>
                    </div>
                    {/* Continue with Google */}
                    <Button className="flex items-center justify-center text-auth-slate border-auth-slate border-[2px] p-2.5 hover:border-auth-slate-h hover:text-auth-slate-h transition-colors font-normal lg:text-lg" 
                    bgVoid={true}>
